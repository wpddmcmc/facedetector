...
const char* params
    = "{ help           | false | print usage          }"
      "{ proto          | res10_300x300_ssd_iter_140000_deploy.prototxt      | model configuration (deploy.prototxt) }"
      "{ model          | res10_300x300_ssd_iter_140000_deploy.caffemodel     | model weights (res10_300x300_ssd_iter_140000.caffemodel) }"
...
int main(int argc, char** argv)
{
    ...
    //! [Initialize network]
    dnn::Net net = readNetFromCaffe("../deploy.prototxt", "../face.caffemodel");
